...
const App = () => {
    ...
    <div className="bg-black min-h-screen">
      ...
      <section id="home" className="w-full p-8 flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/3 flex justify-center md:justify-end">
          <img src="./assets/profile2.png" alt="Sudarshan Thakare" className="rounded-md w-32 md:w-48 mx-auto mb-4" />
  ...
  <div className="md:w-1/2 p-4 order-2 md:order-1 flex flex-col justify-between">
    <div className="text-center mb-4">
      <img src="./assets/profile1.jpg" alt="Sudarshan Thakare" className="rounded-md w-62 md:w-60 mx-auto mb-2" />
