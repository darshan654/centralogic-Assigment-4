    ...
    return (
        <section id="skills" className="w-full p-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                ...
                <SkillCard imageSrc="https://cdn.svgporn.com/logos/mongodb-icon.svg" skillName="MongoDB" />
...
const SkillCard = ({ imageSrc, skillName }) => {
    return (
        <div className="flex flex-col items-center transform hover:scale-110 transition-transform duration-100 ease-in-out">
